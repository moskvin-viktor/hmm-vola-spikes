def main():
    ...
    from src.hmmstock import DataManager, RegimeModelManager
    from src.hmmstock.models import MarkovModelEnum

    # Load configuration
    config = dict(OmegaConf.load("config/data.yaml"))
    ...
    manager = RegimeModelManager(
        multiindexed_df=data,
        config_path="config/model.yaml",
        model_type=MarkovModelEnum.HMM,
    )
    manager.train_all()
